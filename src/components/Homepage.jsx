...
import { FaUserMd, FaShieldAlt, FaHeartbeat } from "react-icons/fa";
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[{
                ...
                description: "Connect with qualified healthcare professionals anytime, anywhere.",
                icon: <FaUserMd className="text-4xl text-teal-600" />
              },
                {
                  title: "Secure Health Records",
                  description: "Your medical history, safely stored and easily accessible when needed.",
                  icon: <FaShieldAlt className="text-4xl text-teal-600" />
                },
                {
                  title: "Personalized Care Plans",
                  description: "Receive tailored health recommendations for your unique profile.",
